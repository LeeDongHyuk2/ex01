...
<body>
	...
	<form action="join" method="post" role="form">
		...
		<div><label><input type="text" id="member_id" name="member_id" placeholder="아이디" ></label></div>
		<div><label><input type="passwrod" id="member_pwd" name="member_pwd" placeholder="비밀번호" ></label></div>
		...
		<div><label><input type="text" id="member_birth" name="member_birth" placeholder="출생년도" ></label></div>
		<div>
